...
bg_1 = ['paper', 'stone', 'paper', (75, 70, 65), 'paper', 'parchment', (200, 190, 170), (80, 70, 60), 'sand', 'plaster', 'wood', 'metal']
materials_1 = ['ink', 'paint', 'ink', 'paint', 'ink', 'faded_black', 'ink', 'paint', 'ink', 'paint', 'engraved', 'raised']
colors_1 = [
    (25, 25, 25),      # 1: charcoal black ink
    (240, 240, 235),  # 2: chalk white paint
    (170, 35, 25),    # 3: vermilion red ink
    (225, 220, 210),  # 4: faded white
    (85, 55, 35),     # 5: sepia brown ink
    (50, 48, 45),     # 6: faded charcoal
    (40, 45, 55),     # 7: iron gall ink
    (185, 140, 45),   # 8: golden ochre pigment
    (35, 55, 95),     # 9: indigo deep blue ink
    (40, 80, 55),     # 10: malachite mineral green
    (40, 40, 40),     # 11: carved
    (40, 40, 40),     # 12: raised
]
concepts_1 = []
for i in range(12):
    concepts_1.append(make_concept(
        i+1, f'concept_{i+1}',
        background=bg_1[i],
        material=materials_1[i],
        glyph_color=colors_1[i],
...
STAGES.append(StageDef(
    ...
    concepts=concepts_1, default_samples=34200, canvas_size=(512, 512), seed_offset=10000
))

# STAGE 2 - Material Variation
materials_2 = ['faded_black', 'faded_white', 'ink', 'paint', 'carved', 'engraved', 'raised', 'glass', 'ink', 'paint', 'carved', 'raised']
bg_2 = ['paper', 'stone', 'wood', 'sand', 'metal', 'parchment', 'plaster', 'paper', 'stone', 'wood', 'sand', 'metal']
colors_2 = [
    (25, 25, 25), (240, 240, 235), (170, 35, 25), (85, 55, 35),
...
STAGES.append(StageDef(
    ...
    concepts=concepts_2, default_samples=34200, canvas_size=(512, 512), seed_offset=20000
))
...
STAGES.append(StageDef(
    ...
    concepts=concepts_3, default_samples=34200, canvas_size=(512, 512), seed_offset=30000
))
...
STAGES.append(StageDef(
    ...
    concepts=concepts_4, default_samples=34200, canvas_size=(512, 512), seed_offset=40000
))
...
STAGES.append(StageDef(
    ...
    concepts=concepts_5, default_samples=34200, canvas_size=(512, 512), seed_offset=50000
))

# STAGE 6 - Multiple Glyphs
concepts_6 = [make_concept(i+1, f'concept_{i+1}', glyphs_per_image=[2,3,4][i%3], mixed_families=(i%2!=0), material=materials_2[i%len(materials_2)]) for i in range(12)]
STAGES.append(StageDef(
    ...
    concepts=concepts_6, default_samples=34200, canvas_size=(768, 512), seed_offset=60000
))
...
STAGES.append(StageDef(
    ...
    concepts=concepts_7, default_samples=34200, canvas_size=(1024, 384), seed_offset=70000
))
...
STAGES.append(StageDef(
    ...
    concepts=concepts_8, default_samples=34200, canvas_size=(1024, 256), seed_offset=80000
))
...
STAGES.append(StageDef(
    ...
    concepts=concepts_9, default_samples=34200, canvas_size=(1024, 768), seed_offset=90000
))
...
STAGES.append(StageDef(
    ...
    concepts=concepts_10, default_samples=34200, canvas_size=(1024, 1024), seed_offset=100000
))
...
STAGES.append(StageDef(
    ...
    concepts=concepts_11, default_samples=34200, canvas_size=(1024, 768), seed_offset=110000
))
